          ...
          children: [
            Center(
              child: AnimatedTextKit(
                animatedTexts: [
                  TyperAnimatedText('FTTH',textStyle: GoogleFonts.abrilFatface(fontSize:28,fontWeight:FontWeight.bold,color: Colors.black)),
                  TyperAnimatedText('App',textStyle: GoogleFonts.abrilFatface(fontSize:28,fontWeight:FontWeight.bold,color: Colors.black)),
