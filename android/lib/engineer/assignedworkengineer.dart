...
class EngineerAssignedTicketsPage extends StatefulWidget {
  const EngineerAssignedTicketsPage({Key? key}) : super(key: key);

  @override
  State<EngineerAssignedTicketsPage> createState() =>
      _EngineerAssignedTicketsPageState();
}

class _EngineerAssignedTicketsPageState
    extends State<EngineerAssignedTicketsPage> {
      ...
      child: ListTile(
        title: Column(
          ...
          children: [
            ...
            Text('Date Issue Raised: ${data['dateIssueRaised'] ?? 'Unknown'}'),
          ],
        ),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Status: ${data['status'] ?? 'Unspecified'}'),
          ],
        ),
